...
insert into convidado (id, nome, quantidade_acompanhantes) values (4, 'Regina', 2);
insert into convidado (id, nome, quantidade_acompanhantes) values (5, 'Maria', 3);
insert into convidado (id, nome, quantidade_acompanhantes) values (6, 'uilson', 2);